...
},
{
  ...
  "body": " Weighted Total Distribution    Category  Weight    Engagement  14%    Homework  16%    Midterms  40%    Final  30%    Total  100%    "
},
{
...
},
{
  ...
  "number": "",
  "title": "✍️ Prep Work 3",
  "body": " ✍️ Prep Work 3   To receive full credit, please complete this prep work entry by the beginning of class July 9 .    Prompts  Use the lecture videos to fill in the blanks below. Record each item in your prep work journal.  Write the logistic equation .  Define the slope function for a 1st-order differential equation.  Define isocline .  Define nullcline .  Write the Principle of Superposition .     "
},
{
  "id": "prep4",
  "level": "1",
...
},
{
  ...
  "number": "",
  "title": "🔎 Loop 1",
  "body": " 🔎 Loop 1   This page will serve as a viewing guide for content that will be required for class on Wednesday, July 1 .    1.1 - What are differential equations?  In this section, we will learn language to describe and classify differential equations. This section satisfies module objectives 1-3.  Watch 🎥Video 1.1.1 (1:43).  Complete the ✅Checkpoint 1.1.1 .  Watch 🎥Video 1.1.2 (2:02).  Complete the ✅Checkpoint 1.1.2 .  🎯 Practice: Try finding the order of the diffential equations given in problems 1-8 in Exercises 1.1 (pg. 10).  Watch 🎥Video 1.1.3 (4:51).  Complete the ✅Checkpoint 1.1.3 .  🎯 Practice: Determine whether each of the diffential equations given in problems 1-8 in Exercises 1.1 (pg. 10) are linear.  After completing this list, you can complete problem 1 from homework 1.    1.2 - What are solutions to differential equations?  In this section, we will learn what solutions to differential equations look like. We will also learn how to verify them and check for intervals of existence. This section satisfies module objectives 4-5.  Watch 🎥Video 1.2.1 (7:46).  Complete the ✅Checkpoint 1.2.1   Watch 🎥Video 1.2.2 (4:16).  Complete the ✅Checkpoint 1.2.2   🎯 Practice: Problems 11, 13, 21, 23 in Exercises 1.1 (pg. 10).  Watch 🎥Video 1.2.3 (3:28).  Complete the ✅Checkpoint 1.2.3   Watch 🎥Video 1.2.4 (3:27).  🎯 Practice: Problems 4-8 (evens), 18, 22 in Exercises 1.2 (pg. 17).  After completing this list, you can complete problem 2 from homework 1.    1.3 - Why should I find solutions to differential equations?  In this section, we will model some simple real-world phenomena using differential equations. We will also investigate the additional context we can glean from using differential equations (as opposed to algebraic equations) in these models.  Watch 🎥Video 1.4.1 (7:38).  Complete the ✅Checkpoint 1.3.1 .  🎯 Practice: Problems 1, 3, 5, 9, 13 in Exercises 1.3 (pg. 28).  After completing this list, you can complete problem 3 from homework 1.   "
},
{
  "id": "loop-2",
  "level": "1",
  ...
  "number": "",
  "title": "🔎 Loop 2",
  "body": " 🔎 Loop 2   This page will serve as a viewing guide for content that will be required for class on Monday, July 6 .    2.1 - Separable Equations  In this section, students will learn to classify and solve separable equations. This satisfies module objectives 1 and 2.  Watch 🎥Video 2.1.1 (2:15).  Complete the ✅Checkpoint 2.1.1 .  Watch 🎥Video 2.1.2 (3:54).  Complete the ✅Checkpoint 2.1.2 .  🎯 Practice: Problems 2-22 (alternating evens) in Exercises 2.2 (pg. 50).      2.2 - Linear Equations  In this section, students will learn to write linear equations and standard form and find their general solutions by using integrating factors. This satisfies module objectives 1 and 4.  Watch 🎥Video 2.2.1 (3:09).  Complete the ✅Checkpoint 2.2.1 .  Watch 🎥Video 2.2.2 (10:05).  Watch 🎥Video 2.2.3 (6:19).  Watch 🎥Video 2.2.4 (6:29).  🎯 Practice: Problems 2-24 (alternating evens) in Exercises 2.2 (pg. 60-61).      2.3 - Exact Equations  In this section, students will learn to classify and solve exact equations. This satisfies module objectives 1 and 3.  Watch 🎥Video 2.3.1 (6:37).  Complete the ✅Checkpoint 2.3.1 .  🎯 Practice: Problems 2-26 (alternating evens) in Exercises 2.3 (pg. 68-69).      2.4 - Substitution  In this section, students will learn how to simplify first-order differential equations using substitution. This satisfies module objective 5.  Watch 🎥Video 2.4.1 (4:46).  🎯 Practice: Problems 2-10 (evens) in Exercises 2.5 (pg. 74).     "
},
{
  "id": "loop-3",
  "level": "1",
...
},
{
  ...
  "number": "",
  "title": "🔎 Loop 4",
  "body": " 🔎 Loop 4   Students should complete all content in this loop before class Monday, July 13 .    3.2 - Higher-Order Homogeneous Equations  In this section, students will learn to solve higher-order linear homogeneous ODEs using their characteristic polynomials. This section satisfies module objectives 2 and 3.  Watch 🎥 Video 3.2.1 (10:42).  Complete ✅ Checkpoint 3.2.1 .  🎯 Practice: Find the characteristic polynomial for the differential equations in problems 2-28 (alternative evens) in Exercises 4.3 (pg. 138).  Watch 🎥 Video 3.2.2 (6:37).  Complete ✅ Checkpoint 3.2.2 .  🎯 Practice: Finish problems 2-28 (alternating evens) in Exercises 4.3 (pg. 138).      3.3 - Method of Undetermined Coefficients  In this section, students will learn to solve higher-order linear nonhomogeneous ODEs using the method of undetermined coefficients. This section satisfies module objective 4.  Watch 🎥 Video 3.3.1 (8:10).  🎯 Practice: Problems 2, 4, 8, 14, 16, 28 in Exercises 4.4 (pg.148).  Watch 🎥 Video 3.3.2 (13:02).  🎯 Practice: Problems 6, 10, 18, 24, 30 in Exercises 4.4 (pg.148).  Watch 🎥 Video 3.3.3 (4:56).  🎯 Practice: Problems 16-34 (evens) in Exercises 4.5 (pg.156-157).  🎥 Video 3.3.4 .  Complete ✅ Checkpoint 3.3.1 .  🎯 Practice: Problems 36-64 (alternating evens) in Exercises 4.5 (pg.156-157).      3.4 - Variation of Parameters  In this section, students will learn to solve higher-order linear nonhomogeneous ODEs using variation of parameters. This section satisfies module objective 4.  Watch 🎥 Video 3.4.1 (16:34).  Watch 🎥 Video 3.4.2 (7:17).  Complete ✅ Checkpoint 3.4.1 .  🎯 Practice: Problems 2-22 in Exercises 4.6 (pg.161-162).     "
},
{
  "id": "loop-6",
  "level": "1",
...
},
{
  ...
  "number": "2",
  "title": "",
  "body": "  Solve the differential equation using substitution.   "
},
{
  "id": "hw3",
  "level": "1",
...
},
{
  ...
  "number": "",
  "title": "📝 Homework 4",
  "body": " 📝 Homework 4    Instructions: This assignment is due Monday, July 13 . Write solutions to the following problems in the space provided. If you need additional space, you may attach scratch work to the back of this sheet. Please be sure any additional work is clearly labeled with the question it corresponds to.     Solve by first \"guessing\" a trial solution and then applying the method of undetermined coefficients.      Find the general solution to by first determining an annihilator for the forcing function and then applying the method of undetermined coefficients.      Find the general solution to using variation of parameters.    "
},
{
  "id": "hw4-3",
  "level": "2",
  ...
  "number": "1",
  "title": "",
  "body": "  Solve by first \"guessing\" a trial solution and then applying the method of undetermined coefficients.   "
},
{
  "id": "hw4-4",
  "level": "2",
  ...
  "number": "2",
  "title": "",
  "body": "  Find the general solution to by first determining an annihilator for the forcing function and then applying the method of undetermined coefficients.   "
},
{
  "id": "hw4-5",
  "level": "2",
...
},
{
  ...
  "number": "",
  "title": "📝 Homework 6",
  "body": " 📝 Homework 6    Instructions: This assignment is due Monday, July 20 . Write solutions to the following problems in the space provided. If you need additional space, you may attach scratch work to the back of this sheet. Please be sure any additional work is clearly labeled with the question it corresponds to.     Find two power series solutions centered about the point for the ODE Write the first 3 terms of each solution.      Find a power series solution for the IVP       Find a general power series solution on for the ODE     "
},
{
  "id": "hw6-3",
  "level": "2",
  ...
  "number": "1",
  "title": "",
  "body": "  Find two power series solutions centered about the point for the ODE Write the first 3 terms of each solution.   "
},
{
  "id": "hw6-4",
  "level": "2",
...
},
{
  ...
  "number": "",
  "title": "📝 Homework 8",
  "body": " 📝 Homework 8    Instructions: This assignment is due Monday, July 27 . Write solutions to the following problems in the space provided. If you need additional space, you may attach scratch work to the back of this sheet. Please be sure any additional work is clearly labeled with the question it corresponds to.      Find all eigenpairs of        Consider the system of ODEs given by Write the system in matrix form.       Write the system without the use of matrices.       Verify that is a solution to on .       Find the general solution to the system on the interval .    "
},
{
  "id": "hw8-3",
  "level": "2",
...
},
{
  ...
  "number": "2",
  "title": "",
  "body": "  Consider the system of ODEs given by Write the system in matrix form.   "
},
{
  "id": "hw8-5",
  "level": "2",
  ...
  "number": "3",
  "title": "",
  "body": "  Write the system without the use of matrices.   "
},
{
  "id": "hw8-6",
  "level": "2",
  ...
  "number": "4",
  "title": "",
  "body": "  Verify that is a solution to on .   "
},
{
  "id": "hw8-7",
  "level": "2",
...
},
{
  ...
  "number": "",
  "title": "📝 Homework 11",
  "body": " 📝 Homework 11    Instructions: This assignment is due Wednesday, August 5 . Write solutions to the following problems in the space provided. If you need additional space, you may attach scratch work to the back of this sheet. Please be sure any additional work is clearly labeled with the question it corresponds to.      Consider the system of ODEs      Find the general solution to the system.      The plot of all points (where varies) is called a trajectory for the system. This plot lives in the - plane, and is called the phase plane for the system. Sketch the trajectory for the case that all parameters in the general solution are equal to 1 in the space provided below.    You may want to try plugging in some values to see what the ordered pair should be. Try 5 different points (and spread them out so you capture all of the information).      If we write the system in the form , we say that the trajectories are defined by the vector-field . That is, is the slope function for the system. Hence, we can extend the idea of a nullcline being the set of critical points for . Find all nullclines for the system and plot them on your phase portrait above.      Previously, we called equilibria stable if trajectories converged to them and unstable when trajectories diverge from them. How would you describe the equilibria you found in part (c)?        A spring-mass system consists of a mass attached to an eastern wall by a spring with constant and damping constant , as well as a mass attached both to by a spring with constant and damping constant , and to a western wall by a spring with constant and damping constant .     Draw a picture of the system in the space provided below.      Consider displacing both masses to the right, but displacing mass 1 further from its starting position than mass 2. List all forces acting on each mass (including their direction) in the space below.      Use Newton's Second Law to write down a second-order ODE for each mass in the system.    Recall that Newton's Second Law describes damped oscillators by       Reduce the order of the system of 2 second-order equations you found in part (c) into a system of 4 first-order equations.      Rewrite the system you found in part (d) using matrices.      Suppose that a driving harmonic force of is applied to . How would this change your model?        A DC motor's armature has resistance and inductance . The motor has torque constant and back-emf constant . It is used to drive a frictionless, rotating flywheel with rotational inertial and coefficient of viscous friction .     Results from physics and engineering tell us that this system can be modeled by the equations Identify the state variables (unknowns) for the system.      Describe the dynamics of the system in plain language (without the use of math, equations, expressions, etc.).      Rewrite the system of ODEs given in part (a) using matrices.      Suppose you were to adjust the flywheel's inertia. In what way would this change the response from the motor; that is, how do the dynamics of the system change?     "
},
{
  "id": "hw11-3",
  "level": "2",
...
},
{
  ...
  "number": "2",
  "title": "",
  "body": "  A spring-mass system consists of a mass attached to an eastern wall by a spring with constant and damping constant , as well as a mass attached both to by a spring with constant and damping constant , and to a western wall by a spring with constant and damping constant .     Draw a picture of the system in the space provided below.      Consider displacing both masses to the right, but displacing mass 1 further from its starting position than mass 2. List all forces acting on each mass (including their direction) in the space below.      Use Newton's Second Law to write down a second-order ODE for each mass in the system.    Recall that Newton's Second Law describes damped oscillators by       Reduce the order of the system of 2 second-order equations you found in part (c) into a system of 4 first-order equations.      Rewrite the system you found in part (d) using matrices.      Suppose that a driving harmonic force of is applied to . How would this change your model?    "
},
{
  "id": "hw11-5",
  "level": "2",
...
},
{
  ...
  "number": "1",
  "title": "",
  "body": "  Classify each of the following differential equations as linear or nonlinear, then determine their orders.                        "
},
{
  "id": "activities-5-3",
  "level": "2",
...
},
{
  ...
  "body": " 🏫 Activity 3 - Modelling First-Order Equations    Instructions: Write solutions to each of the following problems in the space provided. You are encouraged to work in groups, but also encouraged to use your own words to express your ideas.     An circuit consists of an inductor with inductance 0.1 Henrys and a resistor with resistance 50 Ohms.  Kirchoff's second law tells us that the net electromotive force around a closed circuit is equal to the total potential drop across all elements of the circuit.  Ohm's law tells us that the potential drop across a resistor is where is the electric current.  Similarly, physics informs us that the potential drop across an inductor is   A 30V electromotive force is applied to the circuit when the circuit is at rest. Use the information above to model the current in the circuit at time . What does your model suggest about the current as ?      The velocity at time of a falling body with mass can be modelled by the differential equation where the term increases its velocity due to weight and and the term decreases its velocity due to drag.     The terminal velocity of an object is the maximum velocity it can reach while falling. Use the differential equation above to find a formula for the object's terminal velocity.      Assuming no air resistance ( ), solve the differential equation above to find the velocity of the free-falling body.      Use your answers from parts (a) and (b) to determine how long an object must fall before achieving terminal velocity. Assume the object starts at rest.      A 150 lb skydiver jumps headfirst from a plane cruising at an altitude of 20,000 feet. With their technique, they are able to achieve a drag coefficient of . Use your model above, together with to determine their terminal velocity.      Assuming the diver must deploy their parachute by 14,000 feet to ensure a safe landing, how long should they dive for before pulling the cord?       After spring break, 100 students came to campus with the flu. Suppose the campus has 8000 students.     The rate at which the disease spreads is proportional to both the number of infected students and the number of susceptible (uninfected) students. This can be modeled by the PDE Explain why we multiply instead of adding them.      Explain how we can reduce the PDE model above into the ODE model       Find appropriate initial conditions for the model.      Solve the IVP you have built in parts (a)-(c).      How many students would you expect to become infected after 10 days?      Describe the long-term behavior of the flu according to this model. Do your findings sounds true to real life? If not, discuss potential missing factors from the model that could improve its accuracy and write them below.     "
},
{
  "id": "activities-7-3",
  "level": "2",
...
},
{
  ...
  "number": "2",
  "title": "",
  "body": "  The velocity at time of a falling body with mass can be modelled by the differential equation where the term increases its velocity due to weight and and the term decreases its velocity due to drag.     The terminal velocity of an object is the maximum velocity it can reach while falling. Use the differential equation above to find a formula for the object's terminal velocity.      Assuming no air resistance ( ), solve the differential equation above to find the velocity of the free-falling body.      Use your answers from parts (a) and (b) to determine how long an object must fall before achieving terminal velocity. Assume the object starts at rest.      A 150 lb skydiver jumps headfirst from a plane cruising at an altitude of 20,000 feet. With their technique, they are able to achieve a drag coefficient of . Use your model above, together with to determine their terminal velocity.      Assuming the diver must deploy their parachute by 14,000 feet to ensure a safe landing, how long should they dive for before pulling the cord?    "
},
{
  "id": "activities-7-5",
  "level": "2",
  ...
  "number": "3",
  "title": "",
  "body": "  After spring break, 100 students came to campus with the flu. Suppose the campus has 8000 students.     The rate at which the disease spreads is proportional to both the number of infected students and the number of susceptible (uninfected) students. This can be modeled by the PDE Explain why we multiply instead of adding them.      Explain how we can reduce the PDE model above into the ODE model       Find appropriate initial conditions for the model.      Solve the IVP you have built in parts (a)-(c).      How many students would you expect to become infected after 10 days?      Describe the long-term behavior of the flu according to this model. Do your findings sounds true to real life? If not, discuss potential missing factors from the model that could improve its accuracy and write them below.    "
},
{
  "id": "a4",
  "level": "1",
  ...
  "body": " 🏫 Activity 4 - Solving Higher-Order Linear Equations    Instructions: Write solutions to each of the following problems in the space provided. You are encouraged to work in groups, but also encouraged to use your own words to express your ideas. This activity is due at the beginning of class on Wednesday, July 15 .      When finding a complementary solution to an th-order linear nonhomogeneous equation, we first find roots of the characteristic polynomial . We saw that these roots produce the fundamental solutions to the complementary equation. Summarize the different cases we may have for these roots and how they impact the structure of the complementary solution.       Consider the differential equation      Find the complementary solution.      Use annihilators to find the form of the particular solution.      Find a particular solution using the method of undetermined coefficients.      Find a particular solution using variation of parameters. You may use wolframalpha to assist with integrals and determinants.      Write down the general solution.        Consider the differential equation     Find the complementary solution.     Use annihilators to find the form of the particular solution.      Find a particular solution using the method of undetermined coefficients.      Find a particular solution using variation of parameters. You may use wolframalpha to assist with integrals and determinants.      Write down the general solution.        If problems 2 & 3 were exam questions, and you were able to use any method of your choice, which would you chose and why?    These can be personal opinions ;D.    "
},
{
  "id": "a4-3",
  "level": "2",
...
},
{
  ...
  "number": "2",
  "title": "",
  "body": "  Consider the differential equation      Find the complementary solution.      Use annihilators to find the form of the particular solution.      Find a particular solution using the method of undetermined coefficients.      Find a particular solution using variation of parameters. You may use wolframalpha to assist with integrals and determinants.      Write down the general solution.    "
},
{
  "id": "a4-5",
  "level": "2",
...
},
{
  ...
  "number": "4",
  "title": "",
  "body": "  If problems 2 & 3 were exam questions, and you were able to use any method of your choice, which would you chose and why?    These can be personal opinions ;D.   "
},
{
  "id": "a6",
  "level": "1",
...
},
{
  ...
  "number": "3",
  "title": "",
  "body": "  Without actually solving, how many linearly independent power series solutions centered at must exist for the ODE ? How do you know?   "
},
{
  "id": "a6-6",
  "level": "2",
