...
},
{
  ...
  "number": "",
  "title": "🔎 Loop 2",
  "body": " 🔎 Loop 2   This page will serve as a viewing guide for the lecture videos on Chapter 2.    2.1 - Separable Equations  In this section, students will learn to classify and solve separable equations.  Watch 🎥Video 2.1.1 .  Complete the ✅Checkpoint 2.1.1 .  Watch 🎥Video 2.1.2 .  Complete the ✅Checkpoint 2.1.2 .  🎯 Practice: Problems 2-22 (alternating evens) in Exercises 2.2 (pg. 50).      2.2 - Linear Equations  In this section, students will learn to write linear equations and standard form and find their general solutions by using integrating factors.  Watch 🎥Video 2.4.1 .  Watch 🎥Video 2.4.2 .  Complete the ✅Checkpoint 2.4.1 .  Watch 🎥Video 2.4.3 .  Complete the ✅Checkpoint 2.4.2 .  Watch 🎥Video 2.4.4 .  Try all exercises listed in bank 2 from 📝Homework 2 Practice Problems .      2.3 - Exact Equations  In this section, students will learn to classify and solve exact equations.  Watch 🎥Video 2.2.1 .  Complete the ✅Checkpoint 2.2.1 .  Watch 🎥Video 2.2.2 .  🎯 Practice: Problems 2-24 (alternating evens) in Exercises 2.3 (pg. 60-61).      2.4 - Substitution  In this section, students will learn how to simplify first-order differential equations using substitution.  🎯 Practice: Problems 2-22 (alternating evens) in Exercises 2.5 (pg. 74).     "
},
{
  "id": "hwx-assigned",
  "level": "1",
